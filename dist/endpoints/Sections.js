...
function (_Endpoint) {
  ...
  function Sections() {
    ...
    _defineProperty(_assertThisInitialized(_this), "name", "sections");
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return _this2.apiRequest("sections?organizationId=".concat(descriptor.organizationId));
