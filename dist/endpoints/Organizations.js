...
/*#__PURE__*/
function (_Endpoint) {
  _inherits(Organizations, _Endpoint);
  ...
  function Organizations() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Organizations)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "name", "organizations");
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return _this2.apiRequest("organizations/".concat(descriptor.organizationId), {
                      headers: headers
                    });
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return _this3.apiRequest("organizations", {
                      headers: headers
                    });
