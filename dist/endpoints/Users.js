...
function (_Endpoint) {
  ...
  function Users() {
    ...
    _defineProperty(_assertThisInitialized(_this), "name", "users");
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return _this2.apiRequest("users/".concat(descriptor.userId));
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 5:
                    ...
                    return _context2.abrupt("return", (0, _helpers.wrap)(response.data.map(function (membership) {
