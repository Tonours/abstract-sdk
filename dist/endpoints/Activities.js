...
/*#__PURE__*/
function (_Endpoint) {
  _inherits(Activities, _Endpoint);
  ...
  function Activities() {
    ...
    _defineProperty(_assertThisInitialized(_this), "name", "activities");
  ...
  _createClass(Activities, [{
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return _this2.apiRequest("activities/".concat(descriptor.activityId));
    ...
    value: function list(descriptor) {
      ...
      return this.createCursor("list", function () {
        ...
        return {
          api: function api() {
            ...
            return _this3.apiRequest("activities?".concat(query));
          },
          requestOptions: requestOptions
        };
      }, function (response) {
        return (0, _helpers.wrap)(response.data.activities, response);
      });
    }
  }]);
