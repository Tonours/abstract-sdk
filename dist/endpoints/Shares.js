...
function (_Endpoint) {
  ...
  function Shares() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Shares)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "name", "shares");
  ...
  _createClass(Shares, [{
    key: "create",
    value: function create(descriptor, shareInput) {
      var _this2 = this;
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return _this2.apiRequest("share_links", {
                      method: "POST",
                      body: _objectSpread({}, descriptor, {}, shareInput, {
                        commitSha: shareInput.sha
                      }),
                      headers: headers
                    });
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return _this3.apiRequest("share_links/".concat((0, _helpers.inferShareId)(descriptor)), {
                      headers: headers
                    });
