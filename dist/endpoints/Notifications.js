...
/*#__PURE__*/
function (_Endpoint) {
  _inherits(Notifications, _Endpoint);
  ...
  function Notifications() {
    ...
    _defineProperty(_assertThisInitialized(_this), "name", "notifications");
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return _this2.apiRequest("notifications/".concat(descriptor.notificationId));
      ...
      return this.createCursor("list", function () {
        ...
        return {
          api: function api() {
            ...
            return _this3.apiRequest("notifications?".concat(query));
          },
          requestOptions: requestOptions
        };
      }, function (response) {
