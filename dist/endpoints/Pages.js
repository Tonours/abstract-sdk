...
function (_Endpoint) {
  ...
  function Pages() {
    ...
    _defineProperty(_assertThisInitialized(_this), "name", "pages");
                ...
                return _context3.abrupt("return", this.configureRequest("info", {
                  api: function () {
                    ...
                    regeneratorRuntime.mark(function _callee() {
                      var pageId, fileDescriptor, pages, page;
                      return regeneratorRuntime.wrap(function _callee$(_context) {
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                              pageId = latestDescriptor.pageId, fileDescriptor = _objectWithoutProperties(latestDescriptor, ["pageId"]);
                              _context.next = 3;
                              return _this2.list(fileDescriptor);
                            ...
                            case 3:
                              ...
                              throw new _errors.NotFoundError("pageId=".concat(pageId));

                            case 7:
                              return _context.abrupt("return", (0, _helpers.wrap)(page));
                      ...
                      return regeneratorRuntime.wrap(function _callee2$(_context2) {
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            ...
                            case 7:
                              return _context2.abrupt("return", (0, _helpers.wrap)(page));
                      ...
                      return regeneratorRuntime.wrap(function _callee4$(_context4) {
                        while (1) {
                          switch (_context4.prev = _context4.next) {
                            case 0:
                              _context4.next = 2;
                              return _this3.apiRequest("projects/".concat(latestDescriptor.projectId, "/branches/").concat(latestDescriptor.branchId, "/files/").concat(latestDescriptor.fileId, "/pages"));

                            case 2:
                              response = _context4.sent;
                              return _context4.abrupt("return", (0, _helpers.wrap)(response.pages, response));
                        ...
                        while (1) {
                          switch (_context5.prev = _context5.next) {
                            ...
                            case 2:
                              ...
                              return _context5.abrupt("return", (0, _helpers.wrap)(response.pages, response));
