...
function (_Endpoint) {
  ...
  function Stars() {
    ...
    _defineProperty(_assertThisInitialized(_this), "name", "stars");
  ...
  _createClass(Stars, [{
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return _this2.apiRequest("starred");
    ...
    key: "create",
    value: function create(descriptor) {
      var _this3 = this;

      var requestOptions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var starrableId = descriptor.sectionId === undefined ? descriptor.projectId : descriptor.sectionId;
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return _this3.apiRequest("starred/".concat(starrableId), {
                      method: "PUT"
                    });
    ...
    value: function _delete(descriptor) {
      ...
      return this.configureRequest("delete", {
        api: function api() {
          return _this4.apiRequest("starred/".concat(starrableId), {
            method: "DELETE"
          });
        },
        requestOptions: requestOptions
