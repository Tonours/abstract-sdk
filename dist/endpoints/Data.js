...
function (_Endpoint) {
  ...
  function Data() {
    ...
    _defineProperty(_assertThisInitialized(_this), "name", "data");
                      ...
                      return regeneratorRuntime.wrap(function _callee$(_context) {
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                              _context.next = 2;
                              return _this2.apiRequest("projects/".concat(latestDescriptor.projectId, "/branches/").concat(latestDescriptor.branchId, "/commits/").concat(latestDescriptor.sha, "/files/").concat(latestDescriptor.fileId, "/layers/").concat(latestDescriptor.layerId, "/data"));
                      ...
                      return regeneratorRuntime.wrap(function _callee2$(_context2) {
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            case 0:
                              _context2.next = 2;
                              return _this2.cliRequest(["layers", "inspect", latestDescriptor.layerId, "--project-id=".concat(latestDescriptor.projectId), "--branch-id=".concat(latestDescriptor.branchId), "--sha=".concat(latestDescriptor.sha), "--file-id=".concat(latestDescriptor.fileId)]);
